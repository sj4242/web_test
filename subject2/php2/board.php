                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="../accessary_auth.html"> Phone </a></li>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active">
                    <a href="../mother_auth.html"><img src="../Bootstrap_Test_image/main2.jpg" alt="Laptop_1"></a>
                    <div class="carousel-caption">
                        <h3><strong>Discount until May 8</strong></h3>
                        <h4>  </h4>
                    </div>
                </div>
